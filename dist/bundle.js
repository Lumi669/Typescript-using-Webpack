...
define("state/project-state", ["require", "exports", "models/project", "models/project"], function (require, exports, project_js_1, project_js_2) {
    ...
    class ProjectState extends State {
        ...
        removeProject(projectId, newStatus) {
...
define("components/project-input", ["require", "exports", "components/base-component", "util/validation", "decorators/autobind", "state/project-state"], function (require, exports, base_component_js_1, validation_js_1, autobind_js_1, project_state_js_1) {
    ...
    class ProjectInput extends base_component_js_1.Component {
        ...
        gatherUserInput() {
            ...
            if (!(0, validation_js_1.validate)(tiltleValidatable) ||
...
define("components/project-list", ["require", "exports", "decorators/autobind", "components/base-component", "models/project", "state/project-state", "components/project-item"], function (require, exports, autobind_js_3, base_component_js_3, project_js_3, project_state_js_2, project_item_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ProjectList extends base_component_js_3.Component {
        ...
        dropHandler(event) {
            ...
            project_state_js_2.projectState.removeProject(prjId, this.type === "active" ? project_js_3.ProjectStatus.Active : project_js_3.ProjectStatus.Finished);
        }
        dragLeaveHandler(_3) {
            const listEl = this.element.querySelector("ul");
